...
const showtimeSeeds = [
  { movie: "The Lion's Kingdom", cinema: 'CineStar Central', hall: 'Hall A', show_date: '2026-07-01', show_time: '14:30', status: 'active' },
  { movie: 'Galaxy Rush 3', cinema: 'CineStar Central', hall: 'Hall B', show_date: '2026-07-01', show_time: '17:00', status: 'active' },
  { movie: 'Shadow Detective', cinema: 'CineStar Central', hall: 'VIP', show_date: '2026-07-01', show_time: '19:45', status: 'active' },
  { movie: 'Forever & Always', cinema: 'Galaxy Cinema', hall: 'Hall 1', show_date: '2026-07-02', show_time: '20:30', status: 'active' },
  { movie: 'Midnight Horror', cinema: 'Galaxy Cinema', hall: 'IMAX', show_date: '2026-07-03', show_time: '22:15', status: 'active' },
]
